    ...
    <section className='about-page'>
      ...
      <section className='about-info-container'>
        ...
        <article>
          ...
          <p>I have a background in sales and customer service, in tech and tech education, and I have always found ways to make processes easier and more productive for the teams I&apos;ve been involved with.</p>
          <p>I&apos;m eager to bring my coding skills to a collaborative team environment where I can both contribute my expertise and learn from others. I thrive on being part of business growth and tackling challenges head-on, and I&apos;m comfortable working alongside AI tools as part of a modern development workflow</p>
        </article>
        {/* display flex row */}
        <div className='social-links-container'>
          ...
          {/* Email */}
          <a className='social-icons' href='mailto:adraf@me.com?subject=Website%20Request%20From%20adamraffertywebdesign.com' target="_blank" rel="noopener noreferrer">
        ...
        <div className='skills-badge-container'>
          ...
          <Badge className='skills-badge'>
            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
              <path fill="none" stroke="currentColor" d="M5.701 4.57h3.161c.384 0 .739.202.936.531L12 8.791l2.203-3.69a1.09 1.09 0 0 1 .935-.531h3.16m-12.597 0h-1.86a1.09 1.09 0 0 0-.935 1.648l8.158 13.671a1.09 1.09 0 0 0 1.872 0l8.158-13.671a1.09 1.09 0 0 0-.935-1.648h-1.86M5.7 4.57L12 15.124L18.299 4.57"/>
            </svg>
            &nbsp;<span className='skill-badge-span'>Vue</span></Badge>
          <Badge className='skills-badge'>
            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
          ...
          <Badge className='skills-badge'>
            ...
            &nbsp;<span className='skill-badge-span'>Firebase</span></Badge>
          <Badge className='skills-badge'>
            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
